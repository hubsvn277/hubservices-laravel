									...
									<tr>
										...
										<td>
											<div>
											  <div class="form-group">
												<label class="control-label">{{ _lang('Websites Limit') }}</label>						
												<select class="free form-control select2" name="websites_limit[6_months]" required>
													<option value="No">{{ _lang('No') }}</option>
													<option value="Unlimited">{{ _lang('Unlimited') }}</option>
													@for( $i = 1; $i <= 30; $i++ )
														<option value="{{ $i }}">{{ $i }}</option>
									...
									<tr>
										...
										<td>				
											<div>
											  <div class="form-group">
												<label class="control-label">{{ _lang('Recurring Transaction') }}</label>					
												<select class="free form-control select2" name="recurring_transaction[6_months]" required>
													<option value="Yes">{{ _lang('Yes') }}</option>
													<option value="No">{{ _lang('No') }}</option>
												</select>
											  </div>
									...
									<tr>
										...
										<td>								
											<div>
											  <div class="form-group">
												<label class="control-label">{{ _lang('Online Payment') }}</label>						
												<select class="free form-control select2" name="online_payment[6_months]" required>
													<option value="No">{{ _lang('No') }}</option>
													<option value="Yes">{{ _lang('Yes') }}</option>
												</select>
											  </div>
										...
										<td>
											<div>
											  <div class="form-group">
												...
												<input type="text" class="free form-control float-field" name="cost_per_6_months" value="{{ old('cost_per_6_months') }}" required>
											  </div>
											</div>
										</td>
