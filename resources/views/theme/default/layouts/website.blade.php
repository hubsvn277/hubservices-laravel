<!doctype html>
<html lang="{{ get_option('language') == "Vietnamese" ? "vi" : "en" }}" @if(_lang('SYSDIRECTIONDIR') == 'rtl' || get_option('backend_direction') == 'rtl') direction="rtl" dir="rtl" style="direction: rtl" @endif >
    <head>
        <meta charset="utf-8">
