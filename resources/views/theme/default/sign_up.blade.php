        ...
        <div class="row align-items-center">
            ...
            <div class="col-md-auto">
                <a href="{{url('/')}}" class="btn btn-outline-light">
                    <svg xmlns="http://www.w3.org/2000/svg" height="16" viewBox="0 0 16 16" width="16" class="icon svg-default icon-pos-left">
                        <path d="m3.82528129 7h11.17471871v2h-11.16842704l3.23949485 3.2394949-1.41421356 1.4142135-4.24264069-4.24264067-1.41421356-1.41421357 5.65685425-5.65685425 1.41421356 1.41421357z" fill-rule="evenodd"></path>
                    </svg> 
                    {{_lang('Back to home')}}
                </a>
            </div>
						...
						<div class="form-group text-field-group">
							<div >
								<select id="package_type" class="spr-text-field form-control {{ $errors->has('email') ? ' is-invalid' : '' }}" name="package_type" required>
									...
									<option value="6_months">{{ _lang('6 Months Pack') }}</option>
